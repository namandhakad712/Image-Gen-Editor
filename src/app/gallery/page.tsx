  ...
  return (
    <div className="w-full h-[100dvh] relative selection:bg-[var(--accent-color)] selection:text-white overflow-auto">
      ...
      <div className="max-w-7xl mx-auto pt-28 px-4 md:px-6 pb-10">
        ...
        {/* Header */}
        <div className="gallery-header flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
          <div>
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {filteredImages.map(img => (
              <div
                key={img.id}
                className="gallery-card group relative aspect-square rounded-2xl overflow-hidden bg-zinc-100 cursor-pointer shadow-md hover:shadow-xl transition-all"
