...
import { Wand2, ImageIcon, History, Settings, Sparkles } from 'lucide-react';
...
export function Navigation() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 md:top-0 md:bottom-auto md:w-64 md:right-auto border-t md:border-t-0 md:border-r border-zinc-200 bg-white/95 backdrop-blur supports-[backdrop-filter]:bg-white/60 z-50">
      <div className="flex md:flex-col justify-around md:justify-start md:p-4 md:gap-2">
        ...
        <div className="hidden md:flex items-center gap-2 px-3 py-4 mb-2">
          ...
          <span className="text-lg font-bold text-zinc-800">Pollinations</span>
        </div>
