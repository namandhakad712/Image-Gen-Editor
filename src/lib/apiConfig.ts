...
export const DEFAULT_MODELS = {
    image: [
        ...
        { value: 'seedream-pro', label: 'Seedream 4.5' },
    ...
    video: [
        { value: 'wan-fast', label: 'Wan 2.2' },
        { value: 'wan', label: 'Wan 2.6' },
        { value: 'veo', label: 'Veo 3.1 Fast' },
        { value: 'seedance', label: 'Seedance 2.0' },
        { value: 'seedance-pro', label: 'Seedance 1.0 Pro Fast' },
        { value: 'grok-video-pro', label: 'Grok Video Pro' },
        { value: 'ltx-2', label: 'LTX-2 - Fast' },
        { value: 'p-video', label: 'Pruna p-video' },
